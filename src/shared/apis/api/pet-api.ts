...
export const PetApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async addPet(
      pet: Pet,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Pet>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addPet(pet, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["PetApi.addPet"]?.[localVarOperationServerIndex]?.url;
    ...
    async deletePet(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["PetApi.deletePet"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async findPetsByStatus(
      status?: FindPetsByStatusStatus,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Pet>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.findPetsByStatus(status, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["PetApi.findPetsByStatus"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async findPetsByTags(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["PetApi.findPetsByTags"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getPetById(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["PetApi.getPetById"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async updatePet(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["PetApi.updatePet"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async updatePetWithForm(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updatePetWithForm(
        petId,
        name,
        status,
        options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["PetApi.updatePetWithForm"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async uploadFile(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["PetApi.uploadFile"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const PetApiFactory = function (
  ...
  return {
     ...
     */
    addPet(
      requestParameters: PetApiAddPetRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Pet> {
      return localVarFp
        .addPet(requestParameters.pet, options)
    ...
    deletePet(
      ...
      return localVarFp
        .deletePet(requestParameters.petId, requestParameters.apiKey, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Multiple status values can be provided with comma separated strings
    ...
    findPetsByStatus(
      ...
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<Pet>> {
      return localVarFp
        .findPetsByStatus(requestParameters.status, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Multiple tags can be provided with comma separated strings. Use tag1, tag2, tag3 for testing.
    ...
    findPetsByTags(
      ...
      return localVarFp
        .findPetsByTags(requestParameters.tags, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Returns a single pet
    ...
    getPetById(
      ...
      return localVarFp
        .getPetById(requestParameters.petId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Update an existing pet by Id
     ...
     */
    updatePet(
      requestParameters: PetApiUpdatePetRequest,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Pet> {
      return localVarFp
        .updatePet(requestParameters.pet, options)
        .then(request => request(axios, basePath));
    },
    /**
     *
...
export interface PetApiFindPetsByStatusRequest {
   ...
   */
  readonly status?: FindPetsByStatusStatus;
}
