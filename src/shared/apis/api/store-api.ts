  ...
  return {
    ...
    async deleteOrder(
      ...
      const localVarOperationServerBasePath =
        operationServerMap["StoreApi.deleteOrder"]?.[localVarOperationServerIndex]?.url;
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["StoreApi.getInventory"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getOrderById(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["StoreApi.getOrderById"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async placeOrder(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["StoreApi.placeOrder"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const StoreApiFactory = function (
  ...
  return {
    ...
    deleteOrder(
      ...
      return localVarFp
        .deleteOrder(requestParameters.orderId, options)
    ...
    getOrderById(
      ...
      return localVarFp
        .getOrderById(requestParameters.orderId, options)
        .then(request => request(axios, basePath));
    },
    /**
     * Place a new order in the store
     ...
     */
    placeOrder(
      requestParameters: StoreApiPlaceOrderRequest = {},
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Order> {
      return localVarFp
        .placeOrder(requestParameters.order, options)
        .then(request => request(axios, basePath));
    }
  };
};
